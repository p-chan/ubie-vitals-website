...
ユビーの開発では、[markuplint](https://github.com/markuplint/markuplint)と[eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)を利用してコードを静的検査しています。
